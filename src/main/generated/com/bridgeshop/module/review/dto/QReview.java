...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 688719581L;
    ...
    public final com.bridgeshop.module.order.entity.QOrder order;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.bridgeshop.module.order.entity.QOrder(forProperty("order"), inits.get("order")) : null;
