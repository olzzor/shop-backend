package com.bridgeshop.batch.scheduler;

import com.bridgeshop.config.BatchConfig;
...
public class StatsSalesCategoryScheduler {
    ...
    public void runJob() {
        ...
        try {
            jobLauncher.run(batchConfig.StatsSalesCategoryJob(), jobParameters);
